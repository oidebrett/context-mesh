                ...
                <main>
                                    ...
                                    <div className="sm:col-span-3">
                                        ...
                                        <div className="mt-1">
                                            <select
                                                ...
                                                disabled={isEditing} // Disable provider change during edit to avoid confusion
                                            >
                                    ...
                                    <div className="sm:col-span-3">
                                        ...
                                        <div className="mt-1">
                                            <input
                                                ...
                                                className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                                                disabled={isEditing} // Disable model change during edit
                                            />
                                        </div>
                                    </div>
                    ...
                    <div className="bg-white shadow overflow-hidden sm:rounded-lg border border-gray-200">
                        <div className="px-4 py-5 sm:px-6 border-b border-gray-200 bg-gray-50">
                            <h3 className="text-lg leading-6 font-medium text-gray-900">Existing Mappings</h3>
                        </div>
                        <ul className="divide-y divide-gray-200">
                            {isLoading ? (
                                <li className="px-4 py-8 text-center text-gray-500">Loading mappings...</li>
                            ) : mappingsData?.mappings.length === 0 ? (
                                <li className="px-4 py-8 text-center text-gray-500">No mappings configured yet.</li>
                            ) : (
